...
import { DatesConfig, getDateIntervals } from "@rrrcn/services/src/utils/dates";
import type { DataExtractionConfig } from "@rrrcn/services/src/analytics_config_types";
